...
var duckdbBrowser = /*#__PURE__*/Object.freeze({
    ...
    PACKAGE_NAME: v,
    PACKAGE_VERSION: M,
    PACKAGE_VERSION_MAJOR: Ue,
    PACKAGE_VERSION_MINOR: We,
    PACKAGE_VERSION_PATCH: ve,
    StatusCode: ne,
    TokenType: X,
    VoidLogger: A,
    WorkerRequestType: D,
    ...
    WorkerTask: i,
    createWorker: je,
    getJsDelivrBundles: Qe,
    getLogEventLabel: _e,
    getLogLevelLabel: pe,
    getLogOriginLabel: Re,
    getLogTopicLabel: me,
    getPlatformFeatures: le,
    isFirefox: Ge,
    isNode: B,
    isSafari: xe,
    selectBundle: He
