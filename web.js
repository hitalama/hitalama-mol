...
;
	($.$shm_hitalama_analysis_summary) = class $shm_hitalama_analysis_summary extends ($.$shm_hitalama_table) {
		...
		Member_counts(id){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this?.member_counts(id)));
			return obj;
		}
		posts_counts(id){
			return "";
		...
		Sum_member_counts(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this?.sum_member_counts()));
			return obj;
		}
		sum_posts_counts(){
			return "";
	...
	($mol_mem(($.$shm_hitalama_analysis_summary.prototype), "Head_member_counts"));
	...
	($mol_mem(($.$shm_hitalama_analysis_summary.prototype), "Sum_member_counts"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem_key
        ], $shm_hitalama_analysis_summary.prototype, "group", null);
        __decorate([
            $mol_mem_key
        ...
        __decorate([
            $mol_mem_key
        ], $shm_hitalama_analysis_summary.prototype, "member_counts", null);
        __decorate([
            $mol_mem_key
        ], $shm_hitalama_analysis_summary.prototype, "posts_dto_by_ref", null);
        __decorate([
            $mol_mem_key
        ...
        __decorate([
            $mol_mem
        ], $shm_hitalama_analysis_summary.prototype, "sum_member_counts", null);
        __decorate([
            $mol_mem
...
(function ($) {
    ...
    (function ($$) {
        class $shm_hitalama_posts_plots extends $.$shm_hitalama_posts_plots {
            plot_moments() {
                const dto = this.dto_by_owner(this.owner_ids()[0]);
                return dto?.[0].map((time) => new $mol_time_moment(time * 1000)) ?? [];
            }
            labels() {
        ...
        __decorate([
            $mol_mem
        ], $shm_hitalama_posts_plots.prototype, "plot_moments", null);
        __decorate([
            $mol_mem
...
;
	...
	($mol_mem(($.$shm_hitalama_lists_creating.prototype), "Save"));
	($mol_mem(($.$shm_hitalama_lists_creating.prototype), "token"));
...
;
	($.$shm_hitalama_lists) = class $shm_hitalama_lists extends ($.$mol_page) {
		current_view(){
			return (this?.Main());
		}
		Open_create(){
	...
	($mol_mem(($.$shm_hitalama_lists.prototype), "token"));
...
;
var $node = $node || {} ; $node[ "/shm/hitalama/app/foot/foot_logo.png" ] = "data:image/png;base64,"
